...
class TestBase:
    def test_unpack(self):
        ...
        # assert test_struct.position == common.MappedArray([*"xyz"])
...
class TestMappedArray:
    def test_init(self):
        sample_A = common.MappedArray([0, 1, 2])
        sample_B = common.MappedArray([3, 4, 5], ["a", "b", "c"])
        sample_C = common.MappedArray([6, 7, 8, 9], {"D": ["i", "ii"],
                                                     "E": ["iii", " iv"]})
