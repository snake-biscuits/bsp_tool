...
# extracted dirs
spec_of.update({"Alkaline": spec_of["Quake"],
                ...
                "DearEsther/dearester": (valve.sdk_2013, 21),
...
# console dirs
spec_of.update({"Half-Life2": (valve.source, 19),
...
# multi-mod-dir games
id_of.update({"Contagion": id_of["Contagion/contagion"],
