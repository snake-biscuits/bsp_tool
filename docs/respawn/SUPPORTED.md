...
| 2 | 0002 | 47 | `TEXTURE_DATA` | 0 | `respawn.apex_legends.TextureData` | 50% |
...
| 14 | 000E | 47 | `MODELS` | 0 | `respawn.apex_legends.Model` | 66% |
...
| 29 | 001D | 29 | `PHYSICS_COLLIDE` | 0 | `shared.PhysicsCollide` | 100% |
...
|    |      | 47 | `GAME_LUMP.sprp`       | 47 |                                    |   0% |
|    |      | 47 | `GAME_LUMP.sprp.props` |    |                                    |   0% |
| 36 | 0024 | 29 | `LEAF_WATER_DATA` | 0 | `respawn.titanfall.LeafWaterData` | 0% |
...
| 42 | 002A | 29 | `CUBEMAPS` | 0 | `respawn.titanfall.Cubemap` | 50% |
| 43 | 002B | 29 | `TEXTURE_DATA_STRING_DATA` | 0 | `shared.TextureDataStringData` | 100% |
| 43 | 002B | 47 | `UNKNOWN_43` | 0 | | 0% |
| 44 | 002C | 29 | `TEXTURE_DATA_STRING_TABLE` | 0 | `shared.UnsignedShorts` | 100% |
...
| 99 | 0063 | 29 | `CSM_AABB_NODES` | 0 | `respawn.titanfall.Node` | 50% |
...
| 104 | 0068 | 29 | `LIGHTPROBE_REFS` | 0 | | 0% |
...
| 108 | 006C | 29 | `PORTALS` | 0 | `respawn.titanfall.Portal` | 50% |
| 109 | 006D | 29 | `PORTAL_VERTS` | 0 | `respawn.titanfall.Vertex` | 100% |
| 110 | 006E | 29 | `PORTAL_EDGES` | 0 | `respawn.titanfall.PortalEdge` | 100% |
| 111 | 006F | 29 | `PORTAL_VERT_EDGES` | 0 | `respawn.titanfall.PortalEdgeIntersect` | 0% |
| 112 | 0070 | 29 | `PORTAL_VERT_REFS` | 0 | `shared.UnsignedShorts` | 100% |
| 113 | 0071 | 29 | `PORTAL_EDGE_REFS` | 0 | `shared.UnsignedShorts` | 100% |
| 114 | 0072 | 29 | `PORTAL_EDGE_ISECT_AT_EDGE` | 0 | `respawn.titanfall.PortalEdgeIntersect` | 0% |
| 114 | 0072 | 37 | `PORTAL_EDGE_ISECT_EDGE` | 0 | | 0% |
| 115 | 0073 | 29 | `PORTAL_EDGE_ISECT_AT_VERT` | 0 | `respawn.titanfall.PortalEdgeIntersect` | 10% |
| 116 | 0074 | 29 | `PORTAL_EDGE_ISECT_HEADER` | 0 | `respawn.titanfall.PortalEdgeIntersectHeader` | 100% |
| 117 | 0075 | 29 | `OCCLUSION_MESH_VERTS` | 0 | `respawn.titanfall.Vertex` | 100% |
| 118 | 0076 | 29 | `OCCLUSION_MESH_INDICES` | 0 | `shared.Shorts` | 100% |
| 119 | 0077 | 29 | `CELL_AABB_NODES` | 0 | `respawn.titanfall.Node` | 50% |
...
| 125 | 007D | 29 | `SHADOW_MESH_ALPHA_VERTS` | 0 | `respawn.titanfall.ShadowMeshAlphaVertex` | 50% |
| 126 | 007E | 29 | `SHADOW_MESH_INDICES` | 0 | `shared.UnsignedShorts` | 100% |
| 127 | 007F | 29 | `SHADOW_MESH_MESHES` | 0 | `respawn.titanfall.ShadowMesh` | 66% |
