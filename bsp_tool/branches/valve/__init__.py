...
GoldSrc powered Half-Life & CS:1.6.
Valve went on to develop the Source Engine for Half-Life 2."""
__all__ = [
    "alien_swarm", "goldsrc", "left4dead", "left4dead2", "orange_box",
    "orange_box_x360", "physics", "sdk_2013", "sdk_2013_x360", "source",
    "source_filmmaker", "source_xbox"]
...
scripts = [
    alien_swarm, goldsrc, left4dead, left4dead2, orange_box,
    orange_box_x360, sdk_2013, sdk_2013_x360, source,
    source_filmmaker, source_xbox]
