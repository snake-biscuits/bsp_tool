...
class StreamBsp:
    ...
    def deadzones_as_obj(self, filename: str):
        x_scale, y_scale = self.scale
        with open(filename, "w") as obj_file:
            obj_file.write("# generated by bsp_tool.extensions.stbsp\n")
            for b in self.block_4:
                if b.flags == 0x00800000:
                    obj_file.write(f"v {b.first_x * x_scale} {b.first_y * y_scale} 0\n")
                    obj_file.write(f"v {b.first_x * x_scale} {b.last_y * y_scale} 0\n")
                    obj_file.write(f"v {b.last_x * x_scale} {b.last_y * y_scale} 0\n")
                    obj_file.write(f"v {b.last_x * x_scale} {b.first_y * y_scale} 0\n")
