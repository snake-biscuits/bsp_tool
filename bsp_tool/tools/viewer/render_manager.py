...
uniform_setter = {"vec3": lambda uniform_loc, value: gl.glUniform3f(uniform_loc, *value),
...
class RenderManager:
    ...
    vertex_formats: Dict[str, List[(str, str)]]
    ...
    def add_renderable(self, renderable: Renderable):
        # TODO: detect vertex data size / offsets for indices
        # TODO: queue a buffer update & prematurely mark memory allocated for this renderable
        ...
        # TODO: pick a stretch of memory to fit vertex data into
        # whilst not ideal, vertex_data can be split
        # TODO: offset indices to match starting index of memory vertices will be inserted into
